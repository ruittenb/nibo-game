...
- **`index.src.html`** — the source file. All edits go here.
- **`index.html`** — the minified output. Do NOT edit this file directly.
- After changing `index.src.html`, run `make minify-fast` to generate `index.html`.
...
| ρ (rho) | Lρ-P13 | S3-L6-P14 | Teleporter exit S5→S3 (N/θ) — position stays P13, displays at P14 |
| σ (sigma) | Lσ-P14 | S3-L9-P15 | Teleporter exit S5→S3 (ζ/η) — position stays P14, displays at P15 |
| τ (tau) | Lτ-P18 | S5-L4-P18 | Teleporter exit S3→S5 — exits down to L3-P18 |
